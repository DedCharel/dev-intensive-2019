...
class ChatItemTouchHelperCallback(
    ...
    private fun drawIcon(canvas: Canvas, itemView: View, dX: Float) {
        ...
        val space = itemView.resources.getDimensionPixelSize(R.dimen.spacingNormal_16)
    ...
    private fun drawBackground(canvas: Canvas, itemView: View, dX: Float) {
        with(bgRect){
             left = itemView.left.toFloat() // timing 1:41:00 lesson 5
        ...
        //TODO hometask_5 change color depending on the shift (timing 1:42:00 lesson 5)
