...
class ChatAdapter(val listener : (ChatItem) ->Unit): RecyclerView.Adapter<ChatAdapter.ChatItemViewHolder>() {
    companion object{
        private const val ARHIVE_TYPE = 0
    ...
    inner class GroupViewHolder(convertView: View): ChatItemViewHolder(convertView), ChatItemTouchHelperCallback.ItemTouchViewHolder {
